...
const prizes = [
  {
    ...
    amount: '₹5,000',
    icon: <Award size={32} />,
    perks: ['Cash Prize', 'Internship Opportunity', 'Gold Trophy', 'Certificate of Excellence'],
  ...
  },
  {
    ...
    amount: '₹3,000',
    icon: <Star size={28} />,
    perks: ['Cash Prize', 'Silver Trophy', 'Certificate of Excellence', 'Internship Referral'],
  ...
  },
  {
    ...
    amount: '₹2,000',
    icon: <Gift size={26} />,
    perks: ['Cash Prize', 'Bronze Trophy', 'Certificate of Excellence'],
